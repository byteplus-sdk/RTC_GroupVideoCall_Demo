...
@property (nonatomic, strong) GroupVideoCallNameView *nameView;
...
@implementation GroupVideoCallFullScreenView
...
- (GroupVideoCallNameView *)nameView {
    if (!_nameView) {
        _nameView = [[GroupVideoCallNameView alloc] init];
    }
    return _nameView;
}
