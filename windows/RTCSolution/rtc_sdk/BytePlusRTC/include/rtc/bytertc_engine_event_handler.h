...
public:
    ...
    */
     ...
     * @notes   <br>
     *        The callback will be triggered in the following timings. <br>
     ...
     * @param  [in] type The current network connection type, see: NetworkType{@link #NetworkType}.
     */
     ...
     * @param [out] Type Stream  of the recorded stream. See StreamIndex{@link #StreamIndex}
     ...
     * @param  [in] size Length of the message
    ...
    */
     ...
     * @brief Callback of audio device volume.
     * @param [in] device_type device type, Refer to RTCAudioDeviceType{@link #RTCAudioDeviceType} for more details.
     * @param [in] volume Volume value, [0, 255].
     * @param [in] muted Whether is muted state, {true, false}.
     */
     ...
     * @param [in] source_type SEI source type
     * @notes <br>
     ...
     *        + This interface is deprecated, please use onUserStartAudioCapture{@link #IRtcEngineEventHandler#onUserStartAudioCapture} And onUserStopAudioCapture{@link #IRTCRoomEventHandler#onUserStopAudioCapture} <br>
     */
     ...
     * @param  [in] user_id The user who started the internal audio capture
     */
     ...
     * @param  [in] user_id The user who stopped the internal audio capture
     */
     ...
     * @param [in] index Stream type: video from a camera or the screen recorder. See StreamIndex{@link #StreamIndex}.
     ...
     * @param  [in] user_id The user who started the internal video capture
     */
     ...
     * @param  [in] state State of the local audio device, see: LocalAudioStreamState{@link #LocalAudioStreamState}
     ...
     * @param  [in] reason Reason for the remote video stream state change. See RemoteVideoStateChangeReason{@link #RemoteVideoStateChangeReason}.
     */
     ...
     * @param  [in] user Local user information. See RtcUser{@link #RtcUser}
     * @param  [in] state First frame sending state. See FirstFrameSendState{@link #FirstFrameSendState}
     */
