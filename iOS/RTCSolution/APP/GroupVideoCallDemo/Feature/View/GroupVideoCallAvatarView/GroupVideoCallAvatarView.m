...
@interface GroupVideoCallAvatarView ()

@property (nonatomic, assign) GroupVideoCallAvatarViewMicStatus currentMicStatus;

@property (nonatomic, strong) UILabel *centerNameLabel;

@property (nonatomic, strong) UIImageView *volumeImageView;

@property (nonatomic, strong) GroupVideoCallNameView *nameTagView;

@end

@implementation GroupVideoCallAvatarView
...
- (void)setVideoStatus:(GroupVideoCallAvatarViewVideoStatus)status {
    self.videoContainerView.hidden = status == GroupVideoCallAvatarViewVideoStatusOff;
...
- (void)setMicStatus:(GroupVideoCallAvatarViewMicStatus)status {
    ...
    if (status == GroupVideoCallAvatarViewMicStatusSpeaking) {
