...
void TopBarWidget::initContronls() {
    ...
    connect(act_prv_serv, &QAction::triggered, [=] {
        ...
        QDesktopServices::openUrl(QUrl("https://docs.byteplus.com/legal/docs/privacy-policy"));
        emit sigPrvServTriggered();
    });
    connect(act_serv_proto, &QAction::triggered, [=] {
        template_func();

        QDesktopServices::openUrl(QUrl("https://docs.byteplus.com/legal/docs/terms-of-service"));
