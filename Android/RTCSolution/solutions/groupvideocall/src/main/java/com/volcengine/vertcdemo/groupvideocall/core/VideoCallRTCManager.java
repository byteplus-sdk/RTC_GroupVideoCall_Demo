...
import static com.volcengine.vertcdemo.groupvideocall.core.Constants.VOLUME_SPEAKING_INTERVAL;
import static com.volcengine.vertcdemo.groupvideocall.core.Constants.VOLUME_SPEAKING_THRESHOLD;
...
public class VideoCallRTCManager {
    ...
    private final RTCRoomEventHandlerWithRTS mRTCRoomEventHandler = new RTCRoomEventHandlerWithRTS() {
        ...
        public void onRemoteStreamStats(RemoteStreamStats stats) {
            ...
            SolutionDemoEventManager.post(new RemoteStreamStatsEvent(stats, quality));
        }
        /**
    ...
    public void initDefaultVideoEffect() {
        ...
        mRTCVideo.setBeautyIntensity(EffectBeautyMode.WHITE, 0.2F);
        // Set skin smoothing effect
        mRTCVideo.setBeautyIntensity(EffectBeautyMode.SMOOTH, 0.3F);
        // Set the sharpening effect
        mRTCVideo.setBeautyIntensity(EffectBeautyMode.SHARPEN, 0.4F);
    }
    /**
     * Join the RTC room
     *
    ...
    public void useSpeakerphone(boolean use) {
        ...
        if (mRTCVideo != null) {
            ...
            mRTCVideo.setDefaultAudioRoute(use ? AudioRoute.AUDIO_ROUTE_SPEAKERPHONE
