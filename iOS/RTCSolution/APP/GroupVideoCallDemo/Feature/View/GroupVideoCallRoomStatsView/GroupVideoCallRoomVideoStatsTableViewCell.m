...
@interface GroupVideoCallRoomVideoStatsTableViewCell ()
...
@implementation GroupVideoCallRoomVideoStatsTableViewCell
...
- (void)updateUIWithModel:(GroupVideoCallRoomParamInfoModel *)model {
    ...
    switch (model.netQuality) {
        case GroupVideoCallRoomParamNetQualityGood:
            self.netQualityLabel.text = LocalizedString(@"excellent");
            break;
        case GroupVideoCallRoomParamNetQualityNormal:
            self.netQualityLabel.text = LocalizedString(@"good");
            break;
        case GroupVideoCallRoomParamNetQualityBad:
