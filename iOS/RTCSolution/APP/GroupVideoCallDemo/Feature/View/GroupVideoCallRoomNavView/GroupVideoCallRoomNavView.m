...
@interface GroupVideoCallRoomNavView ()
...
@implementation GroupVideoCallRoomNavView
...
- (void)hangeupButtonAction:(UIButton *)sender {
    if ([self.delegate respondsToSelector:@selector(GroupVideoCallRoomNavView:didSelectStatus:)]) {
        [self.delegate GroupVideoCallRoomNavView:self didSelectStatus:RoomNavStatusHangeup];
    }
}

- (void)switchCameraBtn:(UIButton *)sender {
    if ([self.delegate respondsToSelector:@selector(GroupVideoCallRoomNavView:didSelectStatus:)]) {
        [self.delegate GroupVideoCallRoomNavView:self didSelectStatus:RoomNavStatusSwitchCamera];
    }
}
...
- (void)setLocalVideoSession:(GroupVideoCallRoomUserModel *)localVideoSession {
