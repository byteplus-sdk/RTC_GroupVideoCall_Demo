...
@interface GroupVideoCallMockDataComponent ()

@end

@implementation GroupVideoCallMockDataComponent

+ (instancetype)shared {
    static GroupVideoCallMockDataComponent *Component = nil;
    static dispatch_once_t once;
    dispatch_once(&once, ^{
        Component = [[GroupVideoCallMockDataComponent alloc] init];
    });
    return Component;
}
