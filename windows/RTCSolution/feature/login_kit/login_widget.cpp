...
void LoginWidget::initData() {
    ...
    ui.edt_username->setStyleSheet("");
     ui.lbl_rdo_text->setText(tr("agree_service_privacy").arg("<a href=\"https://docs.byteplus.com/legal/docs/terms-of-service\"><span style=\"text-decoration: underline; color:#4080ff; \">" 
         + QObject::tr("terms_service") + "</span></a>").arg("<a href=\"https://docs.byteplus.com/legal/docs/privacy-policy\"><span style=\"text-decoration: underline; color:#4080ff; \">" 
...
void LoginWidget::verifyUserName(const QString& userName) {
    ...
    postDataObj["language"] = language == "Chinese" ? "chinese" : "english";
